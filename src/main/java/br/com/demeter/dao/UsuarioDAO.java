...
public class UsuarioDAO {
	...
	/**
	 * Método para que o usuário possa logar em sua conta, utilizando o email e a
	 * senha que estão salvas no banco de dados.
	 * 
	 * @param email
	 * @param senha
	 * @return UsuarioTO
	...
	/**
	 * Método para validar se um email já está cadastrado no banco de dados.
	 * 
	 * @param email
	 * @return Um boolean, caso esteja = True, caso não esteja = False.
	 * @throws SQLException
	 */
	...
	/**
	 * Método para cadastar um usuário no banco de dados
	 * 
	 * @param usuarioTO
	...
	/**
	 * Método para realizar o cadastro de uma região no banco de dados.
	 * 
	 * @param usuarioTO
